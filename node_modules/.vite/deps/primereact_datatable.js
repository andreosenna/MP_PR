...
import {
  ...
  Dropdown,
  VirtualScroller
} from "./chunk-WD2TOFBD.js";
import {
  OverlayService
} from "./chunk-HPEDG3O5.js";
import {
  TimesIcon
} from "./chunk-SCDRP7ST.js";
import {
  CSSTransition
} from "./chunk-KS7LLCUZ.js";
import {
  InputNumber
} from "./chunk-DBIWLHCU.js";
import {
  InputText
} from "./chunk-PWEX4LUJ.js";
import "./chunk-E532N7UV.js";
import {
  CheckIcon
} from "./chunk-ZBOEOVVM.js";
import {
  Button
} from "./chunk-ABQLBJ4J.js";
import {
  SpinnerIcon
} from "./chunk-C2SBFGCH.js";
import {
  IconBase
} from "./chunk-SME5IG2O.js";
import {
  Ripple
} from "./chunk-26RHU7FB.js";
import {
  Tooltip
} from "./chunk-KWEE2UHA.js";
import {
  Portal
} from "./chunk-RDJ2RQOV.js";
import {
  ComponentBase,
  useEventListener,
  useHandleStyle,
...
var TableBody = React18.memo(React18.forwardRef(function(props, ref) {
  ...
  var createEmptyContent = function createEmptyContent2() {
    ...
    return React18.createElement("tr", emptyMessageProps, React18.createElement("td", bodyCellProps, content2));
  };
  var createGroupHeader = function createGroupHeader2(rowData, rowIndex, expanded, colSpan) {
    if (isSubheaderGrouping && shouldRenderRowGroupHeader(props.value, rowData, rowIndex - props.first)) {
      ...
      if (!options.customRendering) {
        ...
        _content = React18.createElement("td", bodyCellProps, toggler, React18.createElement("span", rowGroupHeaderNameProps, _content));
      }
      ...
      return React18.createElement("tr", rowGroupHeaderProps, _content);
    }
    return null;
  };
  ...
  var createExpansion = function createExpansion2(rowData, rowIndex, expanded, colSpan) {
    if (expanded && !(isSubheaderGrouping && props.expandableRowGroups)) {
      ...
      if (!options.customRendering) {
        ...
        _content2 = React18.createElement("td", bodyCellProps, _content2);
      }
      ...
      return React18.createElement("tr", rowExpansionProps, _content2);
    }
    return null;
  };
  var createGroupFooter = function createGroupFooter2(rowData, rowIndex, expanded, colSpan) {
    if (isSubheaderGrouping && shouldRenderRowGroupFooter(props.value, rowData, rowIndex - props.first, expanded)) {
      ...
      return React18.createElement("tr", rowGroupFooterProps, _content3);
    }
    return null;
  };
  var createContent = function createContent2() {
...
var DataTable = React18.forwardRef(function(inProps, ref) {
  ...
  var _React$useState9 = React18.useState(props.multiSortMeta), _React$useState0 = _slicedToArray2(_React$useState9, 2), multiSortMetaState = _React$useState0[0], setMultiSortMetaState = _React$useState0[1];
  var _React$useState1 = React18.useState(props.filters), _React$useState10 = _slicedToArray2(_React$useState1, 2), filtersState = _React$useState10[0], setFiltersState = _React$useState10[1];
  var _React$useState11 = React18.useState([]), _React$useState12 = _slicedToArray2(_React$useState11, 2), columnOrderState = _React$useState12[0], setColumnOrderState = _React$useState12[1];
  var _React$useState13 = React18.useState(null), _React$useState14 = _slicedToArray2(_React$useState13, 2), groupRowsSortMetaState = _React$useState14[0], setGroupRowsSortMetaState = _React$useState14[1];
  var _React$useState15 = React18.useState({}), _React$useState16 = _slicedToArray2(_React$useState15, 2), editingMetaState = _React$useState16[0], setEditingMetaState = _React$useState16[1];
  var _React$useState17 = React18.useState({}), _React$useState18 = _slicedToArray2(_React$useState17, 2), frozenEditingMetaState = _React$useState18[0], setFrozenEditingMetaState = _React$useState18[1];
  var _React$useState19 = React18.useState(props.rows), _React$useState20 = _slicedToArray2(_React$useState19, 2), d_rowsState = _React$useState20[0], setD_rowsState = _React$useState20[1];
  var _React$useState21 = React18.useState({}), _React$useState22 = _slicedToArray2(_React$useState21, 2), d_filtersState = _React$useState22[0], setD_filtersState = _React$useState22[1];
  var metaData = {
    props,
    state: {
      first: firstState,
  ...
  var restoredRef = React18.useRef(false);
