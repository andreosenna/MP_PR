...
import {
  ChevronLeftIcon
} from "./chunk-E6YGM6CD.js";
import {
  ChevronRightIcon
} from "./chunk-NLNRSBAH.js";
import {
  ChevronDownIcon,
  ChevronUpIcon
} from "./chunk-YVRCK3D5.js";
import {
  OverlayService
} from "./chunk-MFOWILCF.js";
import {
  CSSTransition
} from "./chunk-DRFOWEXG.js";
import {
  InputText
} from "./chunk-VGJMNPIX.js";
import "./chunk-TJFJEUJO.js";
import {
  Button
} from "./chunk-FF43MEHJ.js";
import "./chunk-ETZXRU7R.js";
import {
  Ripple
} from "./chunk-XH5MBDL5.js";
import "./chunk-O4U6WFAA.js";
import {
  Portal
} from "./chunk-VHQPSGVB.js";
import {
  IconBase
} from "./chunk-HS72BCS7.js";
import {
  ComponentBase,
...
var Calendar = React2.memo(React2.forwardRef(function(inProps, ref) {
  ...
  var updateInputfieldRef = React2.useRef(null);
  var _React$useState9 = React2.useState("date"), _React$useState0 = _slicedToArray(_React$useState9, 2), currentView = _React$useState0[0], setCurrentView = _React$useState0[1];
  var _React$useState1 = React2.useState(null), _React$useState10 = _slicedToArray(_React$useState1, 2), currentMonth = _React$useState10[0], setCurrentMonth = _React$useState10[1];
  var _React$useState11 = React2.useState(null), _React$useState12 = _slicedToArray(_React$useState11, 2), currentYear = _React$useState12[0], setCurrentYear = _React$useState12[1];
  var _React$useState13 = React2.useState([]), _React$useState14 = _slicedToArray(_React$useState13, 2), yearOptions = _React$useState14[0], setYearOptions = _React$useState14[1];
  ...
  var createAmPmPicker = function createAmPmPicker2() {
    if (props.hourFormat === "12") {
      var currentTime = getCurrentDateTime();
      var _localeOptions0 = localeOptions(props.locale), am = _localeOptions0.am, pm = _localeOptions0.pm;
      var hour = currentTime.getHours();
  ...
  var createButtonBar = function createButtonBar2() {
    if (props.showButtonBar) {
      var _localeOptions1 = localeOptions(props.locale), today = _localeOptions1.today, clear = _localeOptions1.clear, now = _localeOptions1.now;
